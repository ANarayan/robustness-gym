...
class TestDataset(TestCase):
    ...
    def test_batch(self):
        ...
        self.assertEqual(
            list(self.testbed.dataset.batch(2)),
            [
                {
                    "fast": [False, True],
                    "index": ["0", "1"],
                    ...
                    "text": ["The man is walking.", "The man is running."],
                    "z": [1, 0],
                },
                {
                    "fast": [True, False],
                    ...
                    "label": [1, 1],
                    "metadata": [{"source": "real"}, {"source": "real"}],
                    "text": ["The woman is sprinting.", "The woman is resting."],
                    "z": [1, 0],
                },
                {
                    "fast": [False, False],
                    ...
                    "text": ["The hobbit is flying.", "The hobbit is swimming."],
                    "z": [1, 0],
                },
            ],
        )
